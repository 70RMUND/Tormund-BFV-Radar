...
class RadarSprites():
	def __init__(self):
		...
		self.stationgunwhite = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/sentry-gun.png")
		...
		self.deadicon = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/dead.png")
		...
		self.beaconiconwhite = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/radio.png")
		...
		# Flag White 
		self.flagwhite = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/flag.png")
		...
		# Tank White 
		self.tankwhite = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/tank.png")
		...
		# Plane White 
		self.planewhite = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/plane.png")
		...
		# Car White 
		self.carwhite = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/transport.png")
		...
		# Health Red
		self.health = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/health.png")
		...
		# Ammo Spot 
		self.ammospot = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/ammo_spot.png")
		...
		# Explosive 
		self.explosive = pygame.image.load(os.path.dirname(sys.argv[0])+"/images/explosive.png")
