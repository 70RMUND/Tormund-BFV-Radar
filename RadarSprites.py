...
class RadarSprites():
	def __init__(self):
		...
		self.stationgunwhite = pygame.image.load("./images/sentry-gun.png")
		...
		self.deadicon = pygame.image.load("./images/dead.png")
		...
		self.beaconiconwhite = pygame.image.load("./images/radio.png")
		...
		# Flag White 
		self.flagwhite = pygame.image.load("./images/flag.png")
		...
		# Tank White 
		self.tankwhite = pygame.image.load("./images/tank.png")
		...
		# Plane White 
		self.planewhite = pygame.image.load("./images/plane.png")
		...
		# Car White 
		self.carwhite = pygame.image.load("./images/transport.png")
		...
		# Ammo Spot 
		self.ammospot = pygame.image.load("./images/ammo_spot.png")
		...
		# Explosive 
		self.explosive = pygame.image.load("./images/explosive.png")
