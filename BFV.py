...
def build_offsets(pHandle):
	...
	offsets["GAMERENDERER"]                    = 0x1446C5678
	offsets["CLIENT_GAME_CONTEXT"]             = 0x1446199F8
	offsets["OBJECTIVE_MANAGER"]               = 0x144579010 # FF 0D ? ? ? ? 48 8B 1D [? ? ? ?] 48 8B 43 10 48 8B 4B 08 48 3B C8 74 0E
	offsets["CLIENTSHRINKINGPLAYAREA"]         = 0x144549EF8 # ? 8B F2 48 8B D9 ? 8B 35 [? ? ? ?] ? 85 F6
	offsets["ClientSoldierEntity"]             = 0x144DD96C0
	offsets["ClientVehicleEntity"]             = 0x144CE77E0
	offsets["ClientSupplySphereEntity"]        = 0x144BAE460
	offsets["ClientCombatAreaTriggerEntity"]   = 0x144CE8C60
	offsets["ClientExplosionPackEntity"]       = 0x144DDEE10
	offsets["ClientProxyGrenadeEntity"]        = 0x144DDEAE0
	offsets["ClientGrenadeEntity"]             = 0x144DDED00
	offsets["ClientInteractableGrenadeEntity"] = 0x144B40860
	offsets["ClientCapturePointEntity"]        = 0x144B31C90
	offsets["ClientLootItemEntity"]            = 0x144B65C50
	offsets["ClientArmorVestLootItemEntity"]   = 0x144B66F60
	offsets["ClientStaticModelEntity"]         = 0x144CE0B80
	offsets["PROTECTED_THREAD"]                = 0x1446216A0
	offsets["OBFUS_MGR_PTR_1"]                 = 0x1437AF700
	offsets["OBFUS_MGR_RET_1"]                 = 0x1415E9788
	offsets["OBFUS_MGR_DEC_FUNC"]              = 0x1415A4D50
	offsets["OBJECTIVE_VTBL"]                  = 0x1436B7FA0
	return offsets
