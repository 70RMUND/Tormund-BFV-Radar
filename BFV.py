...
def build_offsets(pHandle):
	...
	offsets["GAMERENDERER"]                    = 0x1446c6678
	offsets["CLIENT_GAME_CONTEXT"]             = 0x14461a9f8
	offsets["OBJECTIVE_MANAGER"]               = 0x14457A010 # FF 0D ? ? ? ? 48 8B 1D [? ? ? ?] 48 8B 43 10 48 8B 4B 08 48 3B C8 74 0E
	offsets["CLIENTSHRINKINGPLAYAREA"]         = 0x14454AEF8 # ? 8B F2 48 8B D9 ? 8B 35 [? ? ? ?] ? 85 F6
	offsets["ClientSoldierEntity"]             = 0x144DDA6C0
	offsets["ClientVehicleEntity"]             = 0x144CE87E0
	offsets["ClientSupplySphereEntity"]        = 0x144BAF460
	offsets["ClientCombatAreaTriggerEntity"]   = 0x144CE9C60
	offsets["ClientExplosionPackEntity"]       = 0x144DDFE10
	offsets["ClientProxyGrenadeEntity"]        = 0x144DDFAE0
	offsets["ClientGrenadeEntity"]             = 0x144DDFD00
	offsets["ClientInteractableGrenadeEntity"] = 0x144B41860
	offsets["ClientCapturePointEntity"]        = 0x144B32C90
	offsets["ClientLootItemEntity"]            = 0x144B66C50
	offsets["ClientArmorVestLootItemEntity"]   = 0x144B67F60
	offsets["ClientStaticModelEntity"]         = 0x144CE1B80
	offsets["PROTECTED_THREAD"]                = 0x1446226A0
	offsets["OBFUS_MGR_PTR_1"]                 = 0x1437B0700
	offsets["OBFUS_MGR_RET_1"]                 = 0x1415E9578
	offsets["OBFUS_MGR_DEC_FUNC"]              = 0x1415A4B40
	offsets["OBJECTIVE_VTBL"]                  = 0x1436B8F80
	return offsets
